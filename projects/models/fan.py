...
class fan_tiny_8_p4_hybrid(FAN):
    def __init__(self, pretrained, out_ids = [0, 1, 2, 3], pretrain_size=224, **kwargs):
        depth = 8
        ...
        super(fan_tiny_8_p4_hybrid, self).__init__(
            img_size=pretrain_size, patch_size=16, in_chans=3, num_classes=80, embed_dim=192, depth=depth, backbone=backbone,
                 num_heads=8, mlp_ratio=4., qkv_bias=True, drop_rate=0., attn_drop_rate=0., drop_path_rate=0.3,
                 act_layer=None, norm_layer=None, cls_attn_layers=2, use_pos_embed=True, eta=1., tokens_norm=True, pretrained=pretrained, out_index=7, out_channel=[128, 256, 192, 768], out_ids=out_ids, use_checkpoint=True)
...
class fan_small_12_p4_hybrid(FAN):
    def __init__(self, pretrained, out_ids = [0, 1, 2, 3], pretrain_size=224, **kwargs):
        ...
        super(fan_small_12_p4_hybrid, self).__init__(
            img_size=pretrain_size, patch_size=16, in_chans=3, num_classes=80, embed_dim=384, depth=depth, backbone=backbone,
                 num_heads=8, mlp_ratio=4., qkv_bias=True, drop_rate=0., attn_drop_rate=0., drop_path_rate=0.3,
                 act_layer=None, norm_layer=None, cls_attn_layers=2, use_pos_embed=True, eta=1., tokens_norm=True, pretrained=pretrained, out_index=9, out_channel=[128, 256, 384, 768], out_ids=out_ids, use_checkpoint=True)
...
class fan_base_12_p4_hybrid(FAN):
    def __init__(self, pretrained, out_ids = [0, 1, 2, 3], pretrain_size=224, **kwargs):
        ...
        super(fan_base_12_p4_hybrid, self).__init__(
            img_size=pretrain_size, patch_size=16, in_chans=3, num_classes=80, embed_dim=448, depth=depth, backbone=backbone,
                 num_heads=8, mlp_ratio=4., qkv_bias=True, drop_rate=0., attn_drop_rate=0., drop_path_rate=0.3,
                 act_layer=None, norm_layer=None, cls_attn_layers=2, use_pos_embed=True, eta=1., tokens_norm=True, pretrained=pretrained, out_index=15, out_channel=[128, 256, 448, 768], out_ids=out_ids, use_checkpoint=True)
...
class fan_large_12_p4_hybrid(FAN):
    def __init__(self, pretrained, out_ids = [0, 1, 2, 3], pretrain_size=224, **kwargs):
        ...
        super(fan_large_12_p4_hybrid, self).__init__(
            img_size=pretrain_size, patch_size=16, in_chans=3, num_classes=80, embed_dim=480, depth=depth, backbone=backbone,
                 num_heads=10, mlp_ratio=4., qkv_bias=True, drop_rate=0., attn_drop_rate=0., drop_path_rate=0.3,
                 act_layer=None, norm_layer=None, cls_attn_layers=2, use_pos_embed=True, eta=1., tokens_norm=True, pretrained=pretrained, out_index=18, out_channel=[128, 256, 480, 768], out_ids=out_ids, use_checkpoint=True)
